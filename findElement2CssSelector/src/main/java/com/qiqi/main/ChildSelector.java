...
public class ChildSelector {
    ...
    public static void main(String[] args) {
        ...
        System.setProperty("webdriver.chrome.driver", ChildSelector.class.getClassLoader().getResource("mac/chromedriver").getPath());
        //创建谷歌浏览器驱动
        WebDriver webDriver = new ChromeDriver();
        //访问百度
        webDriver.get("https://passport.baidu.com/v2/?reg");
        //p元素的子元素中class为pass-text-input-userName的
        ...
        for(WebElement userName:userNames){
            ...
            if(userName.getAttribute("placeholder")!=null&&userName.getAttribute("placeholder").equals("请设置用户名")){
                userName.sendKeys("ChildSelector");//填上findByName
            }
        }

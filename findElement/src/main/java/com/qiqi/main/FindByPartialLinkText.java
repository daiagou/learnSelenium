...
public class FindByPartialLinkText {
    ...
    public static void main(String[] args) {
        ...
        webDriver.findElement(By.partialLinkText("百度用户协议")).click();//1.partialLinkText唯一的情况,click是点击一下

        //2.partialLinkText不唯一的情况：
        List<WebElement> userNames = webDriver.findElements(By.partialLinkText("百度用户协议"));
